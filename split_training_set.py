...
parser.add_argument("train_queries", help="Path of text file containing training queries, one per line")
parser.add_argument("train_gold", help="Path of TSV file containing gold hypernyms for the training queries, separated by tabs")
